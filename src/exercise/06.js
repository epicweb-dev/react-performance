...
function Cell({row, column}) {
  ...
  return <CellImplement row={row} column={column} cell={cell} />
}
Cell = React.memo(Cell)

/**
 * CellImplement won't re-render unless state is changed in <Cell>
 */
function CellImplement({cell, row, column}) {
  const state = useAppState()
  const dispatch = useAppDispatch()
...
CellImplement = React.memo(CellImplement)
