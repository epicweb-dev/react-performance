...
component will not rerender simply because its parent rerendered which could
...
you can do to reduce the amount of unnecessary rerenders throughout your application
...
all rerendered even though no DOM updates were needed. This is an unnecessary
rerender and a bottleneck in our application (especially if we want to start
